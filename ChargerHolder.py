...
cable_holder = Part.makeBox(16, 26, 16)
cable_holder.translate(Vector(48, 0, 24))
...
cyl.translate(App.Vector(56, 13, 24))
...
cut_box = Part.makeBox(16, 4, 16, App.Vector(48, 11, 24))
...
cut_box = Part.makeBox(2.5, 2.5, 16, App.Vector(61.5, 8.5, 24))
...
cut_box = Part.makeBox(2.5, 2.5, 16, App.Vector(61.5, 15, 24))
...
cut_box = Part.makeBox(2.5, 2.5, 16, App.Vector(61.5, 0, 24))
...
cyl_radius = 2.5
cyl_height = 16
cyl_position = Vector(61.5, 8.5, 24)
...
cyl_radius = 2.5
cyl_height = 16
cyl_position = Vector(61.5, 17.5, 24)
...
cyl_radius = 2.5
cyl_height = 16
cyl_position = Vector(61.5, 2.5, 24)
